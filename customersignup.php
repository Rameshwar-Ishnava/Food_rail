<html>
<head>
    <title> Guest Signup | FOOD RAIL</title>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Sign Up <span class="caret"></span> </a>
   ...
   <!-- <ul class="list-unstyled footer-link d-flex footer-social">
          ...
          <div class="col-12 col-md-12 col-sm-12 text-md-center text-center">
            <p style="color:#ff7404">
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> | All Rights Reserved FoodRaiL
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
