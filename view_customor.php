...
<div class="container">
    <div class="container">
        ...
        <a href="view_customor.php" class="list-group-item active">View Customer Details</a>
    	</div>
    </div>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> YOUR Customor LIST </h3>
